...
copyright = f"{current_year}, EK Global"  # pylint: disable=redefined-builtin
...
# pixels large.
html_favicon = "img/favicon-ek-global.ico"
...
latex_documents = [("index", f"{name}.tex", f"Documentation {name}", "EK Global", "howto")]
